...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
        <div class="container">
            ...
            <div class="col-md-4" >
                    <h4 class="mx-auto my-2" >New Post:</h4>
            ...
            <div class="col-md-8">
                ...
                <div style="margin:10px;padding: 20px;border: 1px solid rgb(212, 212, 212)">
                    <span style="font-size:14px;color: rgb(182, 182, 182)">{{$post['created_at']}}</span>
                    <h4>{{$post['title']}}</h4>
                   <p>{{$post['body']}}</p>
